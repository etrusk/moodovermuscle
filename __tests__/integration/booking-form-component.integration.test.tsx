...
describe.skip('Booking Form Component Integration Tests', () => {
  ...
  const fillBookingForm = async (overrides = {}) => {
    ...
    const serviceOption = await screen.findByTestId(
  ...
  it('should validate required fields before submission', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText(/name is required/i) || screen.getByText(/required/i)
      ).toBeInTheDocument()
    })
  })
