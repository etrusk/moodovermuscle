...
function transformBookingForEmail(bookingData: ReturnType<typeof createTestBookingData>) {
  return {
...
describe('Email Service Integration Tests', () => {
  ...
  describe('Customer Confirmation Email', () => {
    ...
    it('should include all booking details in confirmation email', async () => {
      ...
      const result = await sendCustomerConfirmation(transformBookingForEmail(detailedBooking))
  ...
  describe('Admin Notification Email', () => {
    ...
    it('should send notifications for different service types', async () => {
      ...
      for (const service of services) {
        ...
        const result = await sendAdminNotification(transformBookingForEmail(bookingData))
