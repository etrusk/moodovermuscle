...
- [ADR-003: REST API Standards](./adr-003-rest-api-standards.md) - API design patterns that work with rate limiting
- [ADR-020: API Versioning Strategy](./adr-020-api-versioning.md) - Version-specific rate limiting considerations
- [ADR-024: Deployment Strategy](./adr-024-deployment-strategy.md) - Infrastructure considerations for rate limiting
