...
- [ADR-004: Frontend Framework Selection](./adr-004-frontend-framework.md) - React optimization strategies
- [ADR-016: Image Handling Strategy](./adr-016-image-handling.md) - Asset optimization integration
- [ADR-022: Performance Monitoring](./adr-022-performance-monitoring.md) - Bundle performance tracking
