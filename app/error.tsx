...
const ErrorMessage = (): React.ReactElement => (
  <div className="space-y-4">
    ...
    <p className="text-lg text-stone-600 leading-relaxed max-w-lg mx-auto">
      Hi lovely! We&apos;ve hit a little bump in the road. Don&apos;t worry - these
      things happen, and we&apos;re here to help get you back on track.
    </p>
  </div>
)

const ErrorDetails = ({ error }: { error: Error & { digest?: string } }): React.ReactElement | null => {
...
const ActionButtons = ({ onReset }: { onReset: () => void }): React.ReactElement => (
