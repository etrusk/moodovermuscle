...
demonstrate_automation() {
    ...
    echo "   pnpm run lighthouse:test && ./scripts/lighthouse-quality-gates.sh"
    echo ""
    ...
    echo "   pnpm run lighthouse:test  # Runs tests + quality gates"
...
main() {
    ...
    if check_quality_gates; then
        ...
        echo "3. Re-run: pnpm run lighthouse:test"
